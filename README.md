...
This is a tool to estimate flood damage in Japan.
The damage amount is only for three items, structural asset and contents asset, and their total.
This also allows for numerous calculations to be performed at once by specifying the calculation case of Typhoon route in the variable $Route, separated by spaces.
The calculation results are stored in a directory named $output_tif in 03_fld_dmg_jp.py
