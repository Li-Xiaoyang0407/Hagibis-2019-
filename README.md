The files contain data used in the manuscript are described as follow:

(1) dmg.zip
This file contains spatial distribution of flood damage assessment for typhoon-track scenarios caused maximum flood damage in each region.
