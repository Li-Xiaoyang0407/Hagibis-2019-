...
#    calc_nameori = 'flood_out4_' + calc
    ...
    cama_file1 = os.path.join(flood_path, 'flood_lev_c000_zero_tohokul4.bin')

#    cama_fileori = os.path.join(flood_path, calc_nameori+'.bin')
#    cama_fileori1 = os.path.join(flood_path, 'flood_out4_lev_c000_zero_tohokul4.bin')
...
#    df_homeori[calc] = np.nan; df_houseori[calc] = np.nan
...
#    df_houseori[calc] = df_cama['house_damageori'].fillna(0).astype('int32').copy()
...
out_csv = os.path.join(out_dir, 'total_tohoku4e10')
